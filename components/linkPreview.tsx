        ...
        <HoverCardPrimitive.Content className="[transform-origin:var(--radix-hover-card-content-transform-origin)]" side="top" align="center" sideOffset={10}>
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <Link href={url} className="dark:hover:border-neutral-800 block cursor-pointer rounded-md border-2 border-black-primary bg-white p-1 shadow-button-card" style={{ fontSize: 0 }}>
