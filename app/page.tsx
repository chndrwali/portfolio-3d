    ...
    <motion.div className="flex w-full items-center justify-center space-x-6" ref={constraintsRef}>
      ...
      >
        ...
        <div className="flex gap-4">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-black-primary" viewBox="0 0 448 512">
          ...
          <a onClick={() => animatePageOut('/about', router)} className="flex cursor-pointer items-center gap-2 rounded-xl border-2 border-black-primary bg-white p-2 shadow-button shadow-black-primary hover:bg-blue-gray-50/20 md:p-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-black-primary" viewBox="0 0 512 512">
