export function Github() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
      <path
        fill="black"
        fillOpacity={0}
      ...
      <g fill="none" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}>
        ...
        <path strokeDasharray={10} strokeDashoffset={10} d="M9 19C7.59375 19 6.15625 18.4375 5.3125 17.8125C4.46875 17.1875 4.21875 16.1562 3 15.5">
...
export function Twitter() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
      <path fill="black" d="M8.5 2h2.5L11 2h-2.5zM13 2h2.5L15.5 2h-2.5zM10.5 2h5v0h-5zM8.5 2h5v0h-5zM10 2h3.5L13.5 2h-3.5z">
        <animate
          fill="freeze"
          attributeName="d"
          dur="0.8s"
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
      ...
      <g fill="none" stroke="black" strokeLinecap="round" strokeWidth={4}>
        ...
        <path strokeDasharray={24} strokeDashoffset={24} d="M10 15C10 12.2386 12.2386 10 15 10C17.7614 10 20 12.2386 20 15V20">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 md:h-10 md:w-10" viewBox="0 0 24 24">
      <g fill="black" fillOpacity={0}>
        <path d="M5 5L12 5.2L19 5L22 15L19 18.4H5L1.5 15L5 5Z">
          <animate fill="freeze" attributeName="fill-opacity" begin="1.6s" dur="0.15s" values="0;0.3"></animate>
        </path>
        <circle cx={9} cy={12} r={1.5}>
          <animate fill="freeze" attributeName="fill-opacity" begin="1.2s" dur="0.4s" values="0;1"></animate>
        </circle>
        <circle cx={15} cy={12} r={1.5}>
          <animate fill="freeze" attributeName="fill-opacity" begin="1.4s" dur="0.4s" values="0;1"></animate>
        </circle>
      </g>
      <g fill="none" stroke="black" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}>
        <path
        ...
        >
          <animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="30;60"></animate>
        </path>
        <path strokeDasharray={16} strokeDashoffset={16} d="M5.5 16C10.5 18.5 13.5 18.5 18.5 16">
          <animate fill="freeze" attributeName="stroke-dashoffset" begin="0.7s" dur="0.4s" values="16;0"></animate>
        </path>
      </g>
    </svg>
  );
